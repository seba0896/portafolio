        ...
        <header className="bg-light w-100 header">
            <nav className="navbar navbar-expand-lg navbar-light bg-light container">
                <div className="container-fluid d-flex justify-content-around">
                    <div className="logo"><a className="navbar-brand fs-1 fw-bold" href="/">SGR</a></div>
                    ...
                    <ul className="navbar-nav w-100 d-flex justify-content-end">
                        <li className="nav-item">
                            <Link className="nav-link" aria-current="page" href="/portafolio">PORTAFOLIO</Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link" href="/servicios">SERVICIOS</Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link" href="#">ACERCA</Link>
                        </li>
                        <li className="nav-item">
